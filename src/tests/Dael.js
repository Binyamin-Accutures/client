...
// import imgUrl from "../components/ImageManipulation/car_example_out.png"
...
async function convertRGB(imgUrl, {minDoLPVal, maxDoLPVal, RGB_minS0Value, RGB_maxS0Value, AoLPCenter, AoLPPov}) {
...
async function sdfsdfsd() {
    
    const results = await convertAoLPDoLP(imgUrl, {
        HSFactor: 0.2,
        DoLPSatur: 0.4,
        AoLPBright: -0.7
    })
    ...
    document.querySelector('.vvv').appendChild(image)
